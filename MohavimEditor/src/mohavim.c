/**************************************************************************
 *   mohavim.c  --  This file is part of Mohavim (modernized nano fork).  *
 *                                                                        *
 *   Based on GNU nano - Copyright (C) 1999-2011, 2013-2023 FSF, Inc.     *
 *   Mohavim modifications - Copyright (C) 2024 Mohavim Project           *
 *                                                                        *
 *   Mohavim is free software: you can redistribute it and/or modify      *
 *   it under the terms of the GNU General Public License as published    *
 *   by the Free Software Foundation, either version 3 of the License,    *
 *   or (at your option) any later version.                               *
 *                                                                        *
 *   Mohavim is distributed in the hope that it will be useful,           *
...
int main(int argc, char **argv)
{
        ...
        /* Display Mohavim startup logo */
        clear();
        move(LINES / 2 - 4, (COLS - 60) / 2);
        printw("============================================================");
        move(LINES / 2 - 3, (COLS - 60) / 2);
        printw("    #   #  ####  #   #  ####  #   # ##### #   #");
        move(LINES / 2 - 2, (COLS - 60) / 2);
        printw("    ## ## #    # #   # #    # #   #   #   ## ##");
        move(LINES / 2 - 1, (COLS - 60) / 2);
        printw("    # # # #    # ##### ###### #   #   #   # # #");
        move(LINES / 2, (COLS - 60) / 2);
        printw("    #   # #    # #   # #    #  # #    #   #   #");
        move(LINES / 2 + 1, (COLS - 60) / 2);
        printw("    #   #  ####  #   # #    #   #   ##### #   #");
        move(LINES / 2 + 2, (COLS - 60) / 2);
        printw("              💀 MOHAVIM - Fork Modernizado do Nano 💀");
        move(LINES / 2 + 3, (COLS - 60) / 2);
        printw("          Um fork modernizado com interface melhorada");
        move(LINES / 2 + 4, (COLS - 60) / 2);
        printw("============================================================");
        move(LINES / 2 + 6, (COLS - 30) / 2);
...
#define NOTREBOUND  TRUE
        ...
        if (*openfile->filename == '\0' && openfile->totsize == 0 &&
                ...
                statusbar(_("Bem-vindo ao Mohavim. Para ajuda básica, digite Ctrl+G."));
#endif
